...
This project is a web app that displays documents stored in a MongoDB database that complements the AI Powered Note Organizer. It was built as a personal exploration of AI-assisted development tools and as a demonstration of full-stack skills.
